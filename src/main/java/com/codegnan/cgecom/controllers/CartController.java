...
public class CartController {
	...
	/*
	 * @PostMapping("/payment-success") public String
	 * handlePaymentSuccess(HttpSession session) { // Clear the cart from session
	 * session.removeAttribute("cartItems"); session.removeAttribute("totalPrice");
	 * 
	 * // Redirect to products page return "redirect:/products"; }
	 */
